...
`;async function x(e="",{variables:t}={}){let i=await fetch("https://cfuat.in/lgadxb/graphql",{headers:{"Content-Type":"application/json"},method:"POST",body:JSON.stringify({query:e,variables:t}),cache:"no-store"}),s=await i.json();if(s.errors)throw console.error(s.errors),Error("Failed to fetch API");return s.data}async function p(e,t){return await x({home:s,"kids-of-excellence":l,"man-of-valour":a,"contact-us":r,teams:n,"team-page":o,blogs:c,"blogs-by-slug":d,"ministries-by-slug":h,users:u,"our-church":m,utilities:f,"buy-now":g}[e],{variables:{slug:t}})}},8229:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>s});let s={src:"/_next/static/media/logo.0e08d699.webp",height:133,width:158,blurDataURL:"data:image/webp;base64,",blurWidth:8,blurHeight:7}},7633:()=>{}};